          ...
          <Route element={
            ...
            <Route path="/products" element={
                <ProductsPage 
                    ...
                    onBulkToggleProductActiveState={handleBulkToggleProductActiveState} 
                    currentUser={currentUser} 
                    defaultCurrency={systemSettings.defaultCurrency} 
                    customFieldDefinitions={customFieldDefinitions.filter(cfd => cfd.entityType === 'Product')} 
                    deals={deals.filter(d => !d.isDeleted)} // Pass deals to ProductPage
                />
            } />
